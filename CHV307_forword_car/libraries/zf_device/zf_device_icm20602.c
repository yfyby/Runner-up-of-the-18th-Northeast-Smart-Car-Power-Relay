...
float Gyro_x = 0, Gyro_y = 0, Gyro_z = 0;               // 三轴陀螺仪数据      gyro (陀螺仪)
...
void icm20602_get_acc (void)
{
    ...
    Accel_x = (int16)(((uint16)dat[0] << 8 | dat[1]));
    Accel_y = (int16)(((uint16)dat[2] << 8 | dat[3]));
    Accel_z = (int16)(((uint16)dat[4] << 8 | dat[5]));
}
...
void icm20602_get_gyro (void)
{
    ...
    Gyro_x = (int16)(((uint16)dat[0] << 8 | dat[1]));
    Gyro_y = (int16)(((uint16)dat[2] << 8 | dat[3]));
    Gyro_z = (int16)(((uint16)dat[4] << 8 | dat[5]));
    icm20602_gyro_z=Gyro_z;
}
